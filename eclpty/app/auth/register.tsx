        ...
        <View style={styles.form}>
          ...
          <View style={styles.passwordContainer}>
            ...
            <TouchableOpacity onPress={() => setShowPassword(!showPassword)}>
              <Ionicons name={showPassword ? 'eye-off' : 'eye'} size={22} color="#9aa" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.passwordContainer}>
            ...
            <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)}>
              <Ionicons name={showConfirmPassword ? 'eye-off' : 'eye'} size={22} color="#9aa" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.centerRow}>
            <Text style={styles.footer}>Já tem uma conta no nosso App? </Text>
            <TouchableOpacity
              onPress={() => {
                router.push('/auth');
              }}
